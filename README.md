...
<p align="center"><a href="https://wubing2023.github.io/PaperSpine/v5/"><img src="website/assets/brand/paperspine-banner.webp" alt="PaperSpine5 · 从零开始，快速完成一篇图文完整的论文"></a></p>
...
已经安装过时，第二条命令执行可回滚更新，保留任务数据并做一次启动自检。自动更新默认关闭。
