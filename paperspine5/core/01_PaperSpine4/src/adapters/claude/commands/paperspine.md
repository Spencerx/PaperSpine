...
handle that request without starting paper work. Ordinary paper work does not
need an update preflight.

Ordinary paper work proceeds without an update
preflight; this entry is not the PaperSpine5 suite updater.
