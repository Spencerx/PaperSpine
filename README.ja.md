...
すべてのダウンロードは公開リリース一覧に掲載され、SHA-256 で照合できます。現在のバージョンは `v0.4.0-alpha.1-dev` プレリリースです。
...
すでにインストール済みの場合、2 番目のコマンドは巻き戻し可能な更新として動作し、タスクデータを保持したまま起動時のセルフチェックを実行します。自動更新は既定で無効です。
